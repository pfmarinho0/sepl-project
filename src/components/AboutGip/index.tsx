...
export function About() {
  return (
    <Box className='w-full min-h-screen flex items-center justify-center justify-self-center-safe px-5 lg:py-50px sm:px-5 md:px-8 lg:px-16'>
      <Box className="w-full
          sm:max-w-screen-sm 
          md:max-w-screen-md
          lg:max-w-screen-lg
          xl:max-w-screen-xl flex flex-col md:flex-row justify-between items-center gap-12">
